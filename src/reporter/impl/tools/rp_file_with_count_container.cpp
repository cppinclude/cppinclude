...
void FileWithCountContainer::forEachFile( FileCallback _callback ) const
{
...
FileWithCountContainer::Iterator
FileWithCountContainer::begin() const
{
...
FileWithCountContainer::Iterator
FileWithCountContainer::end() const
{
	return m_files.end();
}
